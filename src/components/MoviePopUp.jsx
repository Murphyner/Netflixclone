                ...
                <>
                    <div className="justify-center no-scrollbar items-center flex overflow-x-hidden overflow-y-auto fixed top-5  inset-0 z-50 outline-none focus:outline-none">
                        <div className="relative w-auto  sm:my-6 rounded-lg mx-4 max-w-3xl">
                            {/*content*/}
                            <Fade bottom className="rounded-lg" duration={500}>
                                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-bg-custom outline-none focus:outline-none">
                                    {/*header*/}
                                        <button
                                    ...
                                    {selectedMovie.backdrop_path ? (
                                        <div className="relative">
                                            <img src={`${imageUrl + selectedMovie.backdrop_path}`} className="w-full h-full object-cover"  alt="Movie backdrop" />
                                            <div
                                                style={{
