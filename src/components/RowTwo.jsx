            ...
            <div className='min-h-screen bg-bg-custom'>
                <div className='w-[93%] mx-auto p-2'>
                    <div className='relative top-20 w-full mx-auto'>
                        ...
                        <div>
                            <TransitionGroup className='grid w-full pt-14 mx-auto grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 py-10 grid-flow-row overflow-y-scroll no-scrollbar'>
                                {data?.results.map((item) => (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className='content lg:group-hover:block'>
                                                <Fade top>
